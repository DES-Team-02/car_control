 ...
 */
#ifndef V0_COMMONAPI_CAN_TRANSCEIVER_SOMEIP_PROXY_HPP_
#define V0_COMMONAPI_CAN_TRANSCEIVER_SOMEIP_PROXY_HPP_
...
class CanTransceiverSomeIPProxy
    : virtual public CanTransceiverProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    CanTransceiverSomeIPProxy(
...
#endif // V0_COMMONAPI_Can_Transceiver_SOMEIP_PROXY_HPP_
