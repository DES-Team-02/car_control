...
#ifndef V0_COMMONAPI_Can_Transceiver_SOMEIP_DEPLOYMENT_HPP_
#define V0_COMMONAPI_Can_Transceiver_SOMEIP_DEPLOYMENT_HPP_
...
#endif // V0_COMMONAPI_Can_Transceiver_SOMEIP_DEPLOYMENT_HPP_
